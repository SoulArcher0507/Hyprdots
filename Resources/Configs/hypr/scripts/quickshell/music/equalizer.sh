...
case $cmd in
    ...
    "preset")
        case $arg1 in
            ...
            "Electronic") save_preset 4 4 1 0 -2 0 1 2 4 5 "Electronic" ;;
            "Acoustic") save_preset 2 2 1 0 1 1 2 2 1 0 "Acoustic" ;;
            "Dance")   save_preset 5 4 2 0 -1 -2 0 2 4 4 "Dance" ;;
            "Hip-Hop") save_preset 5 5 2 0 -1 -1 0 1 2 3 "Hip-Hop" ;;
            "Lounge")  save_preset -2 -1 0 1 2 1 0 -1 -2 -2 "Lounge" ;;
            "Piano")   save_preset 1 2 2 1 1 2 3 4 3 2 "Piano" ;;
            "RnB")     save_preset 3 2 1 -1 -2 -1 1 2 2 3 "RnB" ;;
            "Live")    save_preset -1 0 1 2 2 2 1 0 -1 -2 "Live" ;;
        esac
        apply_eq
        ;;
esac
