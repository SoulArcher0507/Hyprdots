...
Item {
    ...
    function specialWorkspaceHasWindows(name) {
        const trimmedName = `${name ?? ""}`.trim();
    ...
    Rectangle { 
        ...
        property real padding: Config.options.overview.backgroundPadding + 24
        ...
        border.width: 1
        border.color: Appearance.moduleBorderColor
        ...
        Item {
            ...
            property color ebAccentColor: Appearance.colors.accent
            property real ebRadius: overviewBackground.radius
            property real ebBorderWidth: overviewBackground.border.width
            property real ebPixelsPerSecond: 120

            readonly property bool ebEffectEnabled: Appearance.edgeAnimationsEnabled && ebBorderWidth > 0 && width > 8 && height > 8
        ...
        Rectangle {
            ...
            height: width
            radius: width / 2
            x: (parent.width * 0.5 - width / 2) + Math.cos(overviewBackground.globalOrbitAngle * 1.5) * 80
            y: (parent.height * 0.1 - height / 2) + Math.sin(overviewBackground.globalOrbitAngle * 1.5) * 100
            opacity: 0.06
        ...
        Rectangle {
            ...
            height: width
            radius: width / 2
            x: (parent.width * 0.2 - width / 2) + Math.sin(overviewBackground.globalOrbitAngle * 1.2) * -60
            y: (parent.height * 0.8 - height / 2) + Math.cos(overviewBackground.globalOrbitAngle * 1.2) * -80
            opacity: 0.05
            color: Appearance.c5
            z: 0
        }
        ...
        Text {
            ...
            transform: Translate { y: backgroundDecoration.drift }
            text: "◈"
            font.family: Appearance.font.family.expressive
            font.pixelSize: Math.min(overviewBackground.width, overviewBackground.height) * 0.34
            color: Appearance.colors.accent
            opacity: 0.04 + (0.01 * Math.sin(overviewBackground.globalOrbitAngle * 4))
            z: 0
        }
        ...
        Rectangle {
            ...
            color: "transparent"
            gradient: Gradient {
                GradientStop { position: 0.0; color: ColorUtils.applyAlpha("#FFFFFF", 0.04) }
                ...
                Repeater {
                    ...
                    Repeater { 
                        ...
                        Rectangle { 
                            ...
                            property bool isEmptyWorkspace: !root.workspaceHasWindows(workspaceValue)
                            property color defaultWorkspaceColor: Appearance.colors.colLayer1
                            property color hoveredWorkspaceColor: ColorUtils.mix(defaultWorkspaceColor, Appearance.colors.colLayer1Hover, 0.1)
                            property color hoveredBorderColor: Appearance.colors.colLayer2Hover
                            property color emptyWorkspaceColor: hoveredWhileDragging ? "#0affffff" : "#05ffffff"
                            ...
                            border.color: hoveredWhileDragging
                                ...
                                : (isEmptyWorkspace ? "#1affffff" : "transparent")
                            ...
                            StyledText {
                                ...
                                color: ColorUtils.applyAlpha(Appearance.colors.colOnLayer1, 0.44)
            ...
            Item {
                ...
                Rectangle {
                    ...
                    StyledText {
                        ...
                        color: ColorUtils.applyAlpha(Appearance.colors.colOnLayer2, 0.96)
                    }
                    ...
                    Grid {
                        ...
                        Repeater {
                            ...
                            delegate: Rectangle {
                                ...
                                property bool isEmptySpecialWorkspace: !root.specialWorkspaceHasWindows(specialName)
                                ...
                                property color emptySpecialWorkspaceColor: (root.draggingTargetSpecialWorkspace === specialName) ? "#0affffff" : "#05ffffff"
                                ...
                                color: "transparent"
                                border.width: 1
                                border.color: isEmptySpecialWorkspace
                                    ? "#1affffff"
                                    : ColorUtils.applyAlpha(Appearance.colors.colLayer2Border, root.glassMode ? root.glassBorderOpacity : 0.75)
